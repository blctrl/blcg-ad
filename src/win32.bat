...
set EPICS_BASE=D:\epics\base-3.14.12.7
REM set EPICS_HOST_ARCH=win32-x86
set PATH=%PATH%;%EPICS_BASE%\bin\%EPICS_HOST_ARCH%
set PATH=%PATH%;%EPICS_BASE%\..\extensions\bin\%EPICS_HOST_ARCH%
...
set EPICS_CA_MAX_ARRAY_BYTES=120000000
