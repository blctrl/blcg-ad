...
my $child_proc;
Win32::Process::Create($child_proc, "./pvAssignStress.exe", "pvAssignStress.exe -S -d ../pvAssignStress.db", 0, 0, ".") || die "Win32::Process::Create() failed: $!";
my $pid = $child_proc->GetProcessID();
system("./pvAssignStress.exe -S -t");
