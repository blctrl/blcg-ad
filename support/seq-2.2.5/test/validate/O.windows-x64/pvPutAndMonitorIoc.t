...
my $child_proc;
Win32::Process::Create($child_proc, "./pvPutAndMonitor.exe", "pvPutAndMonitor.exe -S -d ../pvPutAndMonitor.db", 0, 0, ".") || die "Win32::Process::Create() failed: $!";
my $pid = $child_proc->GetProcessID();
system("./pvPutAndMonitor.exe -S -t");
