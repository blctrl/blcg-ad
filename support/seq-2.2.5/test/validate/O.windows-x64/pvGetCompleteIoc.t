...
my $child_proc;
Win32::Process::Create($child_proc, "./pvGetComplete.exe", "pvGetComplete.exe -S -d ../pvGetComplete.db", 0, 0, ".") || die "Win32::Process::Create() failed: $!";
my $pid = $child_proc->GetProcessID();
system("./pvGetComplete.exe -S -t");
