...
my $child_proc;
Win32::Process::Create($child_proc, "./pvAssignSubst.exe", "pvAssignSubst.exe -S -d ../pvAssignSubst.db", 0, 0, ".") || die "Win32::Process::Create() failed: $!";
my $pid = $child_proc->GetProcessID();
system("./pvAssignSubst.exe -S -t");
