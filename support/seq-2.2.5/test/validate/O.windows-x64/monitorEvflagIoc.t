...
my $child_proc;
Win32::Process::Create($child_proc, "./monitorEvflag.exe", "monitorEvflag.exe -S -d ../monitorEvflag.db", 0, 0, ".") || die "Win32::Process::Create() failed: $!";
my $pid = $child_proc->GetProcessID();
system("./monitorEvflag.exe -S -t");
